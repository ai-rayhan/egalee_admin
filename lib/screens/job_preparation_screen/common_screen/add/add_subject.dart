...
class _AddSubjectScreenState extends State<AddSubjectScreen> {
  ...
  void _addCollectionDocument(BuildContext context) {
    FirebaseFirestore.instance.collection('jobprep').doc(widget.groupName).collection('allSubject').add({
  ...
  void _updateCollectionDocument(BuildContext context) {
    FirebaseFirestore.instance.collection('jobprep').doc(widget.groupName).collection('allSubject').doc(widget.subject?.id).update({
      'title': titleController.text,
      'fee': feeController.text,
      'offerfee': offerFeeController.text,
      'pdflink':imagelink
